...
class CrystallizedState(Serializable):
    fields = [
        # List of validators
        ...
        ('shard_and_committee_for_slots', List(List(ShardAndCommittee))),
       ...
       ( 'last_finalized_slot', 'uint64'),
        ...
        ('crosslink_records', List(CrosslinkRecord)),
    ...
    #     for k in dict(self.fields).keys():
